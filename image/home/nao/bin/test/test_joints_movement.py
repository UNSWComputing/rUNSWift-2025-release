    ...
    try:
        ...
        for joint, min_max in robot.joint_limits:
            ...
            if joint == "LShoulderPitch":
                move_and_check_joint(robot, "LShoulderRoll", 10)

            if joint == "RShoulderPitch":
                move_and_check_joint(robot, "RShoulderRoll", -10)
            ...
            if joint == "LShoulderPitch":
                move_and_check_joint(robot, "LShoulderRoll", 0)

            if joint == "RShoulderPitch":
                move_and_check_joint(robot, "RShoulderRoll", 0)
