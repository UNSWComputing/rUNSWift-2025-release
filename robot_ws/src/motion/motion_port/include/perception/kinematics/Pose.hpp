...
public:
  ...
  /**
     ...
     * @param h of intersection plane.
     */
  RRCoord imageToRobotRelative(Eigen::Vector2i p, int h = 0) const;

  Eigen::Vector2i imageToRobotXY(const Eigen::Vector2i & image, int h = 0) const;
  Eigen::Vector2i imageToRobotXYSlow(const Eigen::Vector2i & image, int h = 0) const;
  Eigen::Vector2i robotToImageXY(Eigen::Vector2i robot, int h = 0) const;
