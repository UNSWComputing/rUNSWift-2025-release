...
#include "runswift_interfaces/srv/ball_cls.hpp"
...
class BallDetector : public rclcpp::Node
{
    ...
    private: 
        ...
        void onCallback(const std::shared_ptr<runswift_interfaces::msg::VisionProcessedImageData> msg);
        ...
        rclcpp::Client<runswift_interfaces::srv::BallCls>::SharedPtr cls_client;

        rclcpp::Publisher<runswift_interfaces::msg::VisionBalls>::SharedPtr vision_balls_publisher;
